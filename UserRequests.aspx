<%@ Page Language="C#" MasterPageFile="~/GM.master" AutoEventWireup="true" CodeFile="UserRequests.aspx.cs" Inherits="UserRequests" Title="Untitled Page" %>
    ...
    <table style="width: 100%">
        <tr>
            ...
            <td style="width: 388px">
                <asp:Label ID="Label5" runat="server" Text="File Requests!" Font-Bold="True" 
                ...
                <asp:Panel ID="Panel2" runat="server" Height="361px" Width="806px">
                    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
                        ...
                        <Columns>
                            ...
                            <asp:ButtonField CommandName="Select" HeaderText="Decryption Key" 
                                ShowHeader="True" Text="Send Key">
                    ...
                    <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
                        ...
                        SelectCommand="SELECT [FileID], [FileName], [UserName], [GroupID] FROM [Request] WHERE (([GroupID] = @GroupID) AND ([Status] = @Status))">
                        <SelectParameters>
